...
/**
 * An unlocked container containing items, usually a small amount of money + a
 * key and/or safe combination
 *
...
public class Desk extends Container implements Serializable {
	...
	public Desk(Point position, Map<String, Integer> items) {
		...
		this.positions.add(new Point((int) position.getX(), (int) position
				.getY() - 1));
	}
