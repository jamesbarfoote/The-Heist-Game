 ...
 * Unlocked with a Safe combination which is currently just a key Does not yet
 * have unlocking minigame, so no safe specific combinations
 *
...
public class Safe extends Container implements Serializable {
	...
	// /**
	// * Generates 4 random integers between 0 and 9, and adds them to the
	// combination array
	...
	// for(int i = 0; i < combination.length; i++){
	// if(comboAttempt[i] != combination[i]){ return false; } //A wrong number
	// was entered
	// }
	// locked = false; //The attempted combo must be correct, so unlocks the
	// safe
	// return true;
	// }
